...
(minemacs-register-on-demand-module 'me-pcap
  :auto-mode '(("\\.\\(?:5vw\\|ap[cs]\\|bfr\\|c\\(?:ap\\|scpkt\\)\\|dmp\\|eth\\|fdc\\|mplog\\|n\\(?:cf\\|tar\\)\\|p\\(?:cap\\(?:ng\\)?\\|kt\\)\\|rf5\\|s\\(?:noop\\|yc\\)\\|t\\(?:pc\\|r\\(?:c[01]\\|[1c]\\)\\)\\|vn\\(?:tc\\)?\\|wpz\\)$" . pcap-mode)))
...
(use-package pcap-mode
  ...
  :mode (rx "." (or "pcap" "pcapng" "ntar" "5vw" "ncf" "tr1" "trc" "trc0" "trc1"
                    ...
                    "tpc" "apc" "wpz" "vntc" "vn" "mplog" "aps" "cscpkt")
            eol)
