...
(autoload '+adb-devices-get "../modules/extras/me-adb"
"Look up SERIAL in DEVICES, as returned by `+adb-devices-parse'.
Return its plist, or with PROPERTY only that property's value.

(fn DEVICES SERIAL &optional PROPERTY)")
(autoload '+adb-select-device "../modules/extras/me-adb"
...
(fn &optional ARG)" t)
(register-definition-prefixes "me-lib" '("+a" "+c" "+d" "+e" "+f" "+get-transient-function" "+i" "+known-scripts" "+l" "+m" "+nerd-icons-icon" "+p" "+r" "+s" "+t" "+un" "+varplist-get" "+with-" "minemacs-"))
...
(register-definition-prefixes "me-lib-x" '("+apply-patch-dwim-" "+browse-html-file-browser-priority" "+c" "+d" "+eglot--help-buffer" "+fetch-json-from-url" "+g" "+html2pdf-" "+json-schemas-" "+monolith-program" "+net-default-device" "+patch-get-patched-files" "+s" "+tramp--convert-sshfs-filename-local"))
