...
(setq
 ...
 org-persist-directory (concat minemacs-cache-dir (let ((d "org/persist/")) (mkdir d t) d))
 org-publish-timestamp-directory (concat minemacs-cache-dir (let ((d "org/publish/timestamps/")) (mkdir d t) d))
 org-preview-latex-image-directory (concat minemacs-cache-dir (let ((d "org/preview/latex-image/")) (mkdir d t) d))
