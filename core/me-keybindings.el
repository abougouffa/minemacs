...
(use-package general
  ...
  (general-create-definer +minemacs--internal-map-key
  ...
  ;; the `+map', `+map-local' and `+map-key' macros that `general' is ready and
  ;; the definers `+minemacs--internal-map', `+minemacs--internal-map-key' and
